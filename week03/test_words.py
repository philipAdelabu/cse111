...
def test_suffix():
    ...
    suf = suffix("language", "damage") # suffix function must return a string
    assert isinstance(suf, str) # assert that the returned value is a string

    assert suffix("", "") == ""
    assert suffix("clear", "correct") == ""
